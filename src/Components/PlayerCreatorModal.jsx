...
export default function PlayerCreatorModal({ onSave, onClose, teamId }) {
  ...
  // ── Overall rating ──
  const ovr = Math.round(ALL_ATTRS.reduce((s, a) => s + attrs[a.key], 0) / ALL_ATTRS.length);
        ...
        <div className="pcm-body">
          ...
          <section className="pcm-section">
            ...
            <div className="pcm-static-grid">
              ...
              <label className="pcm-field pcm-field--half">
              ...
              <label className="pcm-field">
                <span>Numer</span>
                <select 
                  className="pcm-input pcm-select pcm-input--small" 
                  value={shirtNumber} 
              ...
              <label className="pcm-field">
                ...
                >
                  {Array.from({ length: 32 }, (_, i) => i + 14).map(num => (
                    <option key={num} value={num}>{num}</option>
                  ))}
                </select>
              </label>
