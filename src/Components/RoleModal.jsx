...
const ROLE_DESCRIPTIONS = {
  ...
  "Rozgrywający wysunięty boczny obrońca": "Schodzi do półprzestrzeni, pełniąc rolę bocznego rozgrywającego wspierającego atak pozycyjny.",
  ...
  "Łącznik defensywy": "Spaja obronę z atakiem, wybiegając z piłką z głębi pola niczym drugi, ukryty napastnik.",
  ...
  "Pomocnik długodystansowiec": "Transportuje piłkę od własnego do obcego pola karnego, często decydując się na strzały z dystansu.",
  "Cofnięty rozgrywający": "Główny dyrygent zespołu; schodzi przed stoperów, by odebrać piłkę i podyktować tempo i kierunek gry.",
  "Swobodny rozgrywający": "Główny reżyser gry. Ma niemal nieograniczoną swobodę; agresywnie szuka wolnej przestrzeni przed obroną, by dyktować grę.",
  "Cofający się defensywny pomocnik": "W fazie obrony i rozegrania cofa się bardzo głęboko, wchodząc pomiędzy środkowych obrońców.",
  ...
  "Pressujący defensywny pomocnik": "Zorientowany na odbiór piłki. Porzuca swoją pozycję, by biegać za piłką, agresywnie ją odbierać i natychmiast oddawać partnerom.",
  ...
  "Boczny środkowy pomocnik": "Wahadłowy środka pola. Zabezpiecza boczne strefy pomocy i wspiera zespół w szerokiej wymianie podań.",
  "Środkowy pomocnik": "Pracowity zawodnik operujący od pola karnego do pola karnego o wyważonym nastawieniu. Wykonuje systemowe polecenia.",
  "Wychodzący pomocnik": "Ofensywnie zorientowany środkowy pomocnik. Szeroko atakuje półprzestrzenie (pomiędzy środkiem a skrzydłem), często wbiegając na pozycję dla dośrodkowań.",
  "Ofensywny pomocnik": "Klasyczna dziesiątka. Łączy drugą linię z napastnikami, grając tuż za ich plecami w strefie przed polem karnym.",
  "Wolna rola": "Zupełnie wolny elektron w ofensywie. Szuka wolnej przestrzeni. Odpuszcza obowiązki defensywne na rzecz kreacji i morderczej skuteczności z przodu.",
  ...
  "Schodzący napastnik": "Grający bliżej środka skrzydłowy. Zamiast dośrodkowywać, biegnie z piłką po przekątnej prosto na bramkę, stając się de facto dodatkowym snajperem.",
  "Boczny napastnik": "Poszukiwacz przestrzeni na boku boiska. Zaniedbuje kreowanie gry, w zamian znikając z radaru obrońcom przed strzałem.",
  ...
  "Odgrywający": "Główny cel podań. Używa siły fizycznej grając tyłem do bramki. Przyjmuje wysokie piłki, przetrzymuje je i zgrywa nadbiegającym partnerom.",
  ...
  "Wychodzący napastnik": "Szpica ataku. Gra na granicy spalonego, czekając na prostopadłe piłki z głębi pola i skupiając się na zdobywaniu goli.",
  "Lis pola karnego": "Typowy łowca bramek. Nie uczestniczy w rozegraniu piłki. Żyje wyłącznie w polu karnym, polując na dośrodkowania i najmniejsze błędy obrońców.",
  ...
  "Śledzący środkowy napastnik": "Grający presingiem napastnik. Pierwszy obrońca. Haruje bez piłki, nakładając zaciekły, nieustanny pressing na stoperów i bramkarza przeciwnika.",
